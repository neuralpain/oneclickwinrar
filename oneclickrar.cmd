...
$KNOWN_VERSIONS = @(290, 300, 310, 320, 330, 340, 350, 360, 370, 371, 380, 390, 393, 400, 401, 410, 411, 420, 500, 501, 510, 511, 520, 521, 530, 531, 540, 550, 560, 561, 570, 571, 580, 590, 591, 591, 600, 601, 602, 610, 611, 620, 621, 622, 623, 624, 700, 701, 710, 711)
...
function Select-CurrentWinrarInstallation {
  if ($script:WINRAR_INSTALLED_LOCATION -eq $loc96) {
    ...
    do {
      ...
      elseif ($query -eq 2) { $script:WINRAR_INSTALLED_LOCATION = $loc32; break }
    } while ($true)
  }
